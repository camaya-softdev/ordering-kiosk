<style>
    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="row">
                ...
                <div class="col">
                    <button type="button" class="add-resto btn text-white" data-toggle="modal" data-target="#locationModal">
    ...
    <table id="locationTable" class="table table-bordered table-hover custom-table">
    <thead>
        <tr>
            <th>Name</th>
            <th>Location Code</th>
    ...
    <tr>
        ...
        <td>{{ $location->created_at->format('F j, Y, g:i A') }}</td>
        <td>
        <div class="row">
            <!-- Delete button with modal trigger -->
                <div class="col-auto">
                    <button type="button" class="btn btn-link p-0 text-danger" data-toggle="modal" data-target="#confirmationModal{{$location->id}}">
                        <i class="fa-regular fa-trash-can"></i>
                    </button>
                    {{-- call delete resto --}}
                    @include('partials.modal.deleteLocation')
                </div>
                <!-- Update button with modal trigger -->
                <div class="col-auto">
                    <button type="button" class="btn btn-link p-0" data-toggle="modal" data-target="#updateLocationModal{{$location->id}}">
                    ...
                    @include('partials.modal.updateLocation')
