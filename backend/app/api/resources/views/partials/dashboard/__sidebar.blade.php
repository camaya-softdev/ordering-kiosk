    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @if($loginData['user']['username'] == "admin")
          <li class="nav-item">
            <a href="{{ route('outlet') }}" class="nav-link {{ request()->is('account') ? 'active bg-warning' : '' }}" style="color:white!important">
                <i class="nav-icon">
          ...
          <li class="nav-item">
            <a href="{{ route('location') }}" class="nav-link {{ request()->is('location') ? 'active bg-warning text-white' : '' }}" style="color:white!important">
              <i class="nav-icon">
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          @else
          <li class="nav-item">
            <a href="{{ route('resto.view') }}" class="nav-link {{ request()->is('restaurants-view') ? 'active bg-warning' : '' }}" style="color:white!important">
                <i class="nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M6 6H6.01M6 18H6.01M4 2H20C21.1046 2 22 2.89543 22 4V8C22 9.10457 21.1046 10 20 10H4C2.89543 10 2 9.10457 2 8V4C2 2.89543 2.89543 2 4 2ZM4 14H20C21.1046 14 22 14.8954 22 16V20C22 21.1046 21.1046 22 20 22H4C2.89543 22 2 21.1046 2 20V16C2 14.8954 2.89543 14 4 14Z" stroke="#F2F4F7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
          ...
          <li class="nav-item">
            <a href="{{ route('menu') }}" class="nav-link {{ request()->is('menu') ? 'active bg-warning text-white' : '' }}" style="color:white!important">
              <i class="nav-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <li class="nav-item">
            <a href="{{ route('log') }}"  class="nav-link  {{ request()->is('activity-log') ? 'active bg-warning' : '' }}" style="color:white!important">
              <i class="nav-icon">
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
