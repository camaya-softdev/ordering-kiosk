...
<div class="modal fade" id="locationNumberModal" tabindex="-1" role="dialog" aria-labelledby="locationNumberModallLabel" aria-hidden="true">
      ...
      <div class="modal-content" style=" border-radius: 12px;">
        ...
        <div class="modal-body">
          ...
          <form method="POST" action="{{ route('locationNumber.store') }}" enctype="multipart/form-data">
            ...
            <h5>Add a Location Number</h5><br>
