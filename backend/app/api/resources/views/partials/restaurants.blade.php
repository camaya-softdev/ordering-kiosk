...
.active-counter, .inactive-counter {
    margin-left: 10px;
    background: #F2F4F7;
...
<div class="row">
    <div class="col-6">
        <div class="filter-buttons">
            <button id="filterActive" class="btn btn-light">Active <span class="active-counter">2</span></button>
            <button id="filterInactive" class="btn btn-light">Inactive <span class="inactive-counter">2</span></button>
        </div>
    </div>
...
countStatus();
    ...
    document.querySelector('.active-counter').textContent = activeCount;
    document.querySelector('.inactive-counter').textContent = inactiveCount;
}
  ...
  function filterTable(status)
  {
    ...
    document.getElementById('filterActive').addEventListener('click', function() {
        ...
        if (isActiveFilter) {
            ...
            document.getElementById('filterInactive').classList.remove('active-filter');
        }
    ...
    document.getElementById('filterInactive').addEventListener('click', function() {
        ...
        if (isInactiveFilter) {
            ...
            this.classList.add('active-filter');
            // Remove active class from the other button
            document.getElementById('filterActive').classList.remove('active-filter');
        }
        // Toggle button classes
        toggleButtonClasses();
    });
    ...
    function toggleButtonClasses() {
        var filterActiveButton = document.getElementById('filterActive');
        var filterInactiveButton = document.getElementById('filterInactive');

        if (filterActiveButton.classList.contains('active-filter')) {
        ...
        if (filterInactiveButton.classList.contains('active-filter')) {
